...
#Here is an example of the arm moving to 3 positions, then opening, then closing the gripper
...
#Here is an example of the arm moving to a position using joint angles, then opening and closing the gripper
