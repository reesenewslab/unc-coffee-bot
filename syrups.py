...
def move_cup_to_syrup():
    """takes cup from coffee and places it in the syrup spot."""
...
def get_ready_to_syrup():
    """moves arm in position to pump syrup."""
...
def get_cup_again():
    """moves cup from syrup to central location. linear motion"""
